...
func (*validateCouponApplication) isCouponValid(couponFound *prizedraw_dto.CouponDto) *result_app.ApplicationError {
...
func (v *validateCouponApplication) getCouponValidationFromResponse(responseChannel chan []byte) (*prizedraw_dto.CouponValidationData, *result_app.ApplicationError) {
	var couponData = &prizedraw_dto.CouponValidationData{}
...
func (*validateCouponApplication) isPrizeDrawValid(prizeDrawData *prizedraw_dto.PrizeDrawData, selectedPrizeDrawId int) *result_app.ApplicationError {
