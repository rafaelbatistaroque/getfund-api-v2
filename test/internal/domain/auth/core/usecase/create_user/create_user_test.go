...
import (
	...
	fixture "getfund-api-v2/test/internal/domain/auth/core/usecase/create_user/create_user_fixture"
	"testing"
	"time"
...
func Test_GivenCreateUserExecute_WhenInputUsernameEmpty_ThenEnsureReturnError(t *testing.T) {
	// Arrange
	sut, _ := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenInputUsernameInvalid_ThenEnsureReturnError(t *testing.T) {
	// Arrange
	sut, _ := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenInputPasswordConfirmationEmpty_ThenEnsureReturnError(t *testing.T) {
	// Arrange
	sut, _ := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenInputPasswordConfirmationDifferentFromPassword_ThenEnsureReturnError(t *testing.T) {
	// Arrange
	sut, _ := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenInputValid_ThenEnsureCallUserExistsWithCorrectParameter(t *testing.T) {
	// Arrange
...
func Test_GivenCreateUserExecute_WhenUserExistsInvoked_ThenEnsureCallsOnce(t *testing.T) {
	// Arrange
	sut, spies := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenUserExistsError_ThenEnsureReturnNotFoundError(t *testing.T) {
	// Arrange
	sut, spies := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenUserExistsFound_ThenEnsureReturnDuplicateEntryError(t *testing.T) {
	// Arrange
	sut, spies := fixture.NewSut()
...
func Test_GivenCreateUserExecute_WhenUserExistsNotFound_ThenEnsureCallGetRandomCodeWithCorrectParameter(t *testing.T) {
	// Arrange
	sut, spies := fixture.NewSut()
