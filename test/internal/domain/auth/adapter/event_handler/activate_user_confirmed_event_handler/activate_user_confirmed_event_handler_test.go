...
import (
	...
	fixture "getfund-api-v2/test/internal/domain/auth/adapter/event_handler/activate_user_confirmed_event_handler/activate_user_confirmed_event_handler_fixture"
	"testing"
	"time"
