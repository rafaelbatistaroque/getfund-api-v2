...
func GetEntranceDto() *dto.EntranceDto {
...
func GetInvalidEntranceDto() *dto.EntranceDto {
	return &dto.EntranceDto{
...
func ApplyCoupon(couponDto *dto.CouponDto) {
	couponDto.UserCouponApplies = make([]*dto.UserCouponApplyDto, 1)
	couponDto.UserCouponApplies = append(couponDto.UserCouponApplies, &dto.UserCouponApplyDto{CouponId: 1, UserId: 1, IsNewApplication: true})
	couponDto.UserCouponApplies = append(couponDto.UserCouponApplies, &dto.UserCouponApplyDto{CouponId: 2, UserId: 2})
}
