...
import (
	...
	fixture "getfund-api-v2/test/internal/domain/prizedraw/adapter/event_handler/create_user_process_with_coupon_started_event_handler/create_user_process_with_coupon_started_event_handler_fixture"
	"testing"
	"time"
...
func Test_GivenHandler_WhenGetCouponByCodeSuccess_ThenEnsureCallCacheSetWithCorrectParameter(t *testing.T) {
	...
	expectedCacheKey := "fake-activation-data-key_coupon"
	expectedSuccess := fixture.GetCouponDataFromSuccessDB(spies.RepoSpy.SuccessResult["GetCouponByCode"].(*prizedraw_dto.CouponDto))
