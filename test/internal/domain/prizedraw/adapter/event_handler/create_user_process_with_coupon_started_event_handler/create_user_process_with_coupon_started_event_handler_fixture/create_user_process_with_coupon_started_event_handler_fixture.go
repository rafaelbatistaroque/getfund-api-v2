...
import (
	...
	event_handler "getfund-api-v2/internal/domain/prizedraw/adapter/event_handler/create_user_process_with_coupon_started_event_handler"
...
func GetCouponDataFromSuccessDB(couponFromDb *prizedraw_dto.CouponDto) *coupon_common.CouponData {
