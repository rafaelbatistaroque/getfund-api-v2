...
import (
	...
	fixture "getfund-api-v2/test/external/domain/coupon/event_handler/create_user_process_with_coupon_started_event_handler/create_user_process_with_coupon_started_event_handler_fixture"
	"testing"
	"time"
...
func Test_GivenHandler_WhenGetCouponByCodeSuccess_ThenEnsureCallCacheSetWithCorrectParameter(t *testing.T) {
	// Arrange
	sut, spies := fixture.NewSut()
	spies.RepoSpy.DefineGetCouponByCodeSuccess()
	expectedCacheKey := "fake-activation-data-key_coupon"
