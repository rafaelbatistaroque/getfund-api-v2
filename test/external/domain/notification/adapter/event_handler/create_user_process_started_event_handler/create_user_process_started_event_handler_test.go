...
import (
	fixture "getfund-api-v2/test/external/domain/notification/adapter/event_handler/create_user_process_started_event_handler/create_user_process_started_event_handler_fixture"
	"testing"
